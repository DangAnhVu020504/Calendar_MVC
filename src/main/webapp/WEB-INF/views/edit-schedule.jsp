                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="startDate" name="startDate" 
                                           value="<fmt:formatDate value='${schedule.startDate}' pattern='yyyy-MM-dd\'T\'HH:mm'/>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="endDate" name="endDate" 
                                           value="<fmt:formatDate value='${schedule.endDate}' pattern='yyyy-MM-dd\'T\'HH:mm'/>">
                                </div>
                            </div>
                        </div>
