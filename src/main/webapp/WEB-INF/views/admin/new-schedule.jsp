...
<body style="background-color: #f8f9fa;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3" id="endDateGroup">
                                    ...
                                    <input type="datetime-local" class="form-control" id="endDate" name="end Date">
                                </div>
    ...
    <script>
        // Đợi toàn bộ nội dung HTML được tải xong rồi mới thực thi đoạn mã bên trong
        document.addEventListener('DOMContentLoaded', function() {
            // lấy tham số từ URL thông qua window.location.search
            const urlParams = new URLSearchParams(window.location.search);
            const selectedDateStr = urlParams.get('date'); // lấy ngày được chọn từ URL gán cho selectedDateStr để làm ngày mặc định cho input ngày bắt đầu
            ...
            //khi ngươi dùng thay đổi loại lịch trình thì sẽ gọi hàm toggleTypeFields
            typeInput.addEventListener('change', toggleTypeFields);
            toggleTypeFields(); // Gọi hàm ngay khi trang được tải để thiết lập trạng thái ban đầu
