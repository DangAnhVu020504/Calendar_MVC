    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="${pageContext.request.contextPath}/admin/schedules/${schedule.id}/edit" class="btn btn-primary me-2">
                    <i class="fas fa-edit"></i> Sửa lịch trình
                </a>
                <form action="${pageContext.request.contextPath}/admin/schedules/${schedule.id}/delete" method="POST" class="d-inline">
