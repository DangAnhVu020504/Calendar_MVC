...
public interface ScheduleService {
    ...
    void deleteRecurringGroup(Long userId, String title, Long exceptId);
    void updateRecurringGroupToType(Long userId, String title, String newType, String newPriority, String newColor, String newDescription, java.time.LocalDateTime newEndDate);
}